...
app.post('/incoming', async (req, res) => {
  try {
    ...
    `<Response>
      <Connect>
        <ConversationRelay url="wss://${process.env.SERVER}/sockets" dtmfDetection="true" ttsProvider="ElevenLabs" voice="${record.voice}" language="${record.language}" transcriptionProvider="${record.transcriptionProvider}">
